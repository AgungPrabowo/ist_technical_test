...
ResponseProfileModel responseProfileModelFromJson(String str) =>
    ResponseProfileModel.fromJson(json.decode(str));

String responseProfileModelToJson(ResponseProfileModel data) =>
